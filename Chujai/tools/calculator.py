...
class CalculatorTool(BaseTool):
    ...
    Chujai can handle your numbers with precision and care.
    """
    ...
    def execute(self, expression: str, **kwargs) -> Union[Dict[str, Any], ToolResult]:
        ...
        try:
            ...
            # Add some Chujai flair for certain numbers
            if "42" in clean_expr:
                logging.info("Chujai calculator triggered an easter egg: 42")
            elif "69" in clean_expr:
                logging.info("Chujai calculator is keeping it professional...")
            ...
            # Add some Chujai humor based on the result
            if result == 69:
                logging.info("Chujai calculator is maintaining its composure...")
            elif result == 404:
                logging.info("Chujai calculator lost something in the backend...")
            elif result == 42:
                logging.info("Chujai calculator found the meaning of life!")
    ...
    def _eval_expr(self, node: ast.AST) -> float:
        ...
        # Binary operations (e.g., 2 + 3, 4 * 5)
            ...
            if isinstance(node.op, ast.Div) and right == 0:
                raise ValueError("Chujai cannot divide by zero - it's too tight!")
